<template>
    ...
    <ul :class="wrapClasses" :style="styles" v-else>
        <span :class="[prefixCls + '-total']" v-if="showTotal">
            <slot>{{ locale.total }} {{ total }} <template v-if="total <= 1">{{ locale.item }}</template><template v-else>{{ locale.items }}</template></slot>
        </span>
        <li
            :title="locale.prev"
            :class="prevClasses"
        ...
        <li :title="locale.prev5" v-if="currentPage - 3 > 1" :class="[prefixCls + '-item-jump-prev']" @click="fastPrev"><a></a></li>
        ...
        <li :title="locale.next5" v-if="currentPage + 3 < allPages" :class="[prefixCls + '-item-jump-next']" @click="fastNext"><a></a></li>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            locale(){
              return {...this.defaultLocale,...this.customLocale}
            },
            allPages () {
